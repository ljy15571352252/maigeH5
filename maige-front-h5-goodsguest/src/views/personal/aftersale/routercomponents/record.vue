<template>
  <div class="v-personal-aftersale-record">
      ...
      <div class="shops" v-for="(item,index) in dataArr" :key="index">
        ...
        <ul class="orderList">
          <li class="order">
            ...
            <div class="btnWrap">
              <!-- <span class="btn_afterSale btn_cancel">取消售后</span> -->
              <span
                class="btn_afterSale"
...
<script>
//引入url
import { aftersalepage, userreceive } from "@/configs/interface.js";
