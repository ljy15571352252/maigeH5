<template>
  <div class="v-personal-aftersale-processing">
      ...
      <div class="shops" v-for="(item,index) in dataArr" :key="index">
        ...
        <ul class="orderList">
          <li class="order">
            ...
            <div class="waiting" @click="$router.push({name:'aftersaleticket',query:{afterId:item.afterId,complainId:item.complainId}})">
...
.v-personal-aftersale-processing {
  // 订单
  .shops {
