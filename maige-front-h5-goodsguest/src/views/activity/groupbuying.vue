<template>
  <div class="v-activity-groupbuying">
    <navbar title="团购专区" defaultColor="#fff" endColor="#fff" color="#333"></navbar>
    <van-list v-model="loading" :finished="finished" finished-text="没有更多了" @load="onLoad">
      <div class="banner1 wrap">
        <img class="inherit_size" src="~assets/images/activity/banner_groupbuying@2x.png" alt />
      </div>
      <div class="wrapper">
