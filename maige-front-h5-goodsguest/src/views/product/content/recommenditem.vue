<template>
  <div class="v-product-content-recommenditem" @click="toDetail(item)">
    <div class="img_box">
    ...
    <div class="item_content">
      ...
      <div class="footer_box">
        <div>
          ...
          <div v-if="item.salesNum" class="sales">月销{{item.salesNum || 0}}件</div>
        </div>
 ...
 */
import { addShopCart, getShopCartNum, getClickCount } from "@/configs/common.js";
...
.v-product-content-recommenditem {
  width: 170px;
  height: 280px;
  margin-top: 10px;
  display: flex;
...
.v-product-content-recommenditem:nth-of-type(2n) {
  margin-left: 10px;
}
</style>
